const travelTips = [
  ...
  },
  {
    ...
    desc:
      "Sed tempor condimentum metus non tempor. Maecenas non augue aliquam.",
    date: "27 August",
    read: "12 mins read",
    views: "23K views",
  },
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <aside className="space-y-8">
          ...
          <div className="bg-white rounded-xl shadow p-6 text-center">
            ...
            <h4 className="mt-4 font-semibold">Hello, I'm Steven</h4>
            ...
            <div className="flex justify-center gap-3 mt-4">
              ...
              <span className="w-8 h-8 rounded-full bg-sky-400 text-white flex items-center justify-center text-xs">
                t
              </span>
              <span className="w-8 h-8 rounded-full bg-red-500 text-white flex items-center justify-center text-xs">
                p
              </span>
            </div>
          </div>
